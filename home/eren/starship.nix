    ...
    settings =
      ...
      in
      {
        ...
        git_branch = {
          symbol = "";
          style = "bg:${color_bg3}";
          format = "[[ $symbol $branch ](fg:${color_accent} bg:${color_bg3})]($style)";
        };
        git_status = {
          style = "bg:${color_bg3}";
          format = "[[($all_status$ahead_behind )](fg:${color_accent} bg:${color_bg3})]($style)";
        };
        ...
        c = {
          symbol = " ";
          style = "bg:${color_bg4}";
          format = "[[ $symbol ($version) ](fg:${color_accent} bg:${color_bg4})]($style)";
        };
        cpp = {
          symbol = " ";
          style = "bg:${color_bg4}";
        ...
        nix_shell = {
          symbol = " ";
          style = "bg:${color_bg4}";
          format = "[[ $symbol ($name) ](fg:${color_accent} bg:${color_bg4})]($style)";
        };
        package = {
          symbol = " ";
          style = "bg:${color_bg4}";
